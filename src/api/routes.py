...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .ind-btn:hover::after { content: attr(data-tooltip); position: absolute; background: #2c3e50; color: white; padding: 12px 16px; border-radius: 4px; font-size: 12px; white-space: normal; max-width: 280px; bottom: 130%; left: 50%; transform: translateX(-50%); z-index: 999; box-shadow: 0 2px 8px rgba(0,0,0,0.2); line-height: 1.5; text-align: center; }
